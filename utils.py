...
def orient_fsi_and_omega(
    ...
    anchor_smooth_days: int = 63,
    corr_window_freeze: int = 250,
    corr_window_flip: int = 45,
    min_corr_to_freeze: float = 0.2,
    allow_flip_cosine_thresh: float = 0.1,
    flip_persist_days: int = 8,
